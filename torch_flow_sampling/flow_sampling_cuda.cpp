...
/*
  ...
  Please see the documentation for flow_sampling_cpu() in flow_sampling_cpu.cpp;
...
/*
   ...
   in flow_sampling_cpu.cpp for a longer discussion.
*/
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("flow_sampling_cuda", &flow_sampling_cuda, "Flow sampling forward function (CUDA)");
  m.def("flow_sampling_backward_cuda", &flow_sampling_backward_cuda, "Flow sampling backward function (CUDA)");
}
